...
if ( apply_filters( 'woocommerce_mercadopago_help_message', true ) ) : ?>
	<div class="updated woocommerce-message">
		<p><?php echo esc_html( sprintf( __( 'Help us keep the %s plugin free making a donation or rate &#9733;&#9733;&#9733;&#9733;&#9733; on WordPress.org. Thank you in advance!', 'woocommerce-mercadopago' ), __( 'WooCommerce MercadoPago', 'woocommerce-mercadopago' ) ) ); ?></p>
