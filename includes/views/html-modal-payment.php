...
<?php if ( $url ) : ?>
	...
	<a id="submit-payment" href="<?php $url; ?>" name="MP-Checkout" class="button alt" mp-mode="modal"><?php __( 'Pay via MercadoPago', 'woocommerce-mercadopago' ); ?></a> <a class="button cancel" href="<?php esc_url( $order->get_cancel_order_url() ); ?>"><?php __( 'Cancel order &amp; restore cart', 'woocommerce-mercadopago' ); ?></a>
